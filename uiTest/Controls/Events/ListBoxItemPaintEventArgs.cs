...
namespace Fluid.Controls
{
    ...
    public class ListBoxItemPaintEventArgs : ListBoxItemEventArgs
    {
        ...
        public void PaintHeaderBackground()
        {
            ...
            Color startColor = Drawing.GdiPlus.ColorConverter.AlphaBlendColor(Color.White, color, 100);
            if (IsTransparent)
            {
                color = Drawing.GdiPlus.ColorConverter.AlphaColor(color, 200);
                startColor = Drawing.GdiPlus.ColorConverter.AlphaColor(startColor, 150);
                using (GraphicsPlus gp = new GraphicsPlus(g))
                {
                    Drawing.GdiPlus.PointF p1 = new Drawing.GdiPlus.PointF(r.X, r.Y);
                    Drawing.GdiPlus.PointF p2 = new Drawing.GdiPlus.PointF(r.X, r.Bottom);
        ...
        private void PaintTemplateBackground()
        {
            ...
            if (IsTransparent)
            {
                color = Drawing.GdiPlus.ColorConverter.AlphaColor(color, 220);
                using (GraphicsPlus gp = new GraphicsPlus(g))
                {
