...
namespace Fluid.Controls
{
    public class FlatButton : FluidButton
    {
        ...
        protected override void PaintButtonBackground(FluidPaintEventArgs e)
        {
            ...
            Color lightColor = Drawing.GdiPlus.ColorConverter.AlphaBlendColor(darkColor, Color.White, 48);

            if (!Enabled)
            {
                darkColor = Drawing.GdiPlus.ColorConverter.AlphaBlendColor(Color.Black, darkColor, 128);
                lightColor = Drawing.GdiPlus.ColorConverter.AlphaBlendColor(Color.Black, lightColor, 128);
            }
