...
namespace YandexTrains.Models.DepartureBoard
{
    public class Departure
    {
        ...
        public Departure(DepartureResponse departureResponseModel)
        {
            ...
            ScheduledDeparture = DateTime.ParseExact(string.Format("{0} {1}", 
                departureResponseModel.ScheduledDate, departureResponseModel.ScheduledTime),
            ...
            if (!string.IsNullOrEmpty(realDate) || !string.IsNullOrEmpty(realTime))
                RealisticDeparture = DateTime.ParseExact(string.Format("{0} {1}", 
                    realDate, realTime), "yyyy-MM-dd HH:mm", 
