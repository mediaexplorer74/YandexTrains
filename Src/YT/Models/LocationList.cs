...
namespace YandexTrains.Models
{
    public class LocationList
    {
        ...
        {
            DateTime.TryParseExact(string.Format("{0} {1}", 
                locationListResponseModel.ServerDate, locationListResponseModel.ServerTime), 
            ...
            StopLocations = locationListResponseModel.StopLocations?.Select(
                stopLocResponseModel => new StopLocation(stopLocResponseModel));
        }
